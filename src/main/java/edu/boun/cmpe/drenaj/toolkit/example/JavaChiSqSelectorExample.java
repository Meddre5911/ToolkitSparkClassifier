...
package edu.boun.cmpe.drenaj.toolkit.example;
...
public class JavaChiSqSelectorExample {
	public static void main(String[] args) {
		...
		// $example on$
		JavaRDD<LabeledPoint> points = MLUtils.loadLibSVMFile(jsc.sc(), "data/mllib/sample_libsvm_data.txt").toJavaRDD()
				.cache();
		...
		ChiSqSelector selector = new ChiSqSelector(5);
